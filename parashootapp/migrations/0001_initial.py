# Generated by Django 4.1.7 on 2023-08-29 14:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('City', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.city', verbose_name='City')),
            ],
        ),
        migrations.CreateModel(
            name='Contract',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Address2', models.CharField(max_length=500, verbose_name='Address2')),
                ('City', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.city', verbose_name='City')),
                ('Country', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.country', verbose_name='Country')),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='parashootapp.client', verbose_name='Client')),
            ],
        ),
        migrations.CreateModel(
            name='Expense',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Client', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.client', verbose_name='Client')),
                ('EndClient', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.endclient', verbose_name='End Client')),
            ],
        ),
        migrations.CreateModel(
            name='ProjectStatus',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Billable', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.billable')),
                ('City', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.city', verbose_name='City')),
                ('Client', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.client', verbose_name='Client')),
                ('Contract', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.contract', verbose_name='Contract')),
                ('Country', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.country', verbose_name='Country')),
                ('EndClient', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.endclient', verbose_name='End Client')),
                ('Project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.project', verbose_name='Project')),
            ],
        ),
        migrations.CreateModel(
            name='TicketStatus',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FEngg', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.fieldengineer', verbose_name='Field Engineer')),
                ('RemoteClient', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.client', verbose_name='Remote Client')),
                ('Ticket', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.ticket', verbose_name='Ticket No')),
            ],
        ),
        migrations.CreateModel(
            name='TicketSubType',
            fields=[
                ...
                ('TicketType', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.tickettype', verbose_name='Ticket Type')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Status', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.ticketstatus', verbose_name='Status')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FieldEngineer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.fieldengineer', verbose_name='Field Engineer')),
                ('TicketNo', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.ticket', verbose_name='Ticket No')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FieldEngineer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.fieldengineer', verbose_name='Field Engineer')),
                ('TicketNo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.ticket', verbose_name='Ticket No')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('FEngineer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.fieldengineer', verbose_name='Field Engineer')),
                ('Ticket', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.ticket', verbose_name='Ticket No')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='ticket',
            name='TicketType',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.tickettype', verbose_name='Ticket Type'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('Ticket', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.ticket', verbose_name='Ticket')),
                ('TicketStatus', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.ticketstatus', verbose_name='Ticket Status')),
            ],
        ),
        migrations.CreateModel(
            name='Province',
            fields=[
                ...
                ('Country', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.country', verbose_name='Country Name')),
            ],
        ),
        migrations.CreateModel(
            name='ProjectSubType',
            fields=[
                ...
                ('ProjectType', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.projecttype', verbose_name='Project Type')),
            ],
        ),
        migrations.AddField(
            model_name='project',
            name='ProjectStauts',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.projectstatus', verbose_name='Project Status'),
        ),
        migrations.AddField(
            model_name='project',
            name='ProjectType',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.projecttype', verbose_name='Project Type'),
        ),
        migrations.CreateModel(
            name='FEWork',
            fields=[
                ...
                ('FEngg', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.fieldengineer', verbose_name='Field Engineer')),
                ('FStatus', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.festatus', verbose_name='Field Engineer Status')),
                ('Ticket', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.ticket', verbose_name='Ticket')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Area', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.area', verbose_name='Area Name')),
                ('City', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.city', verbose_name='City')),
                ('CustomerCategory', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.customercategory', verbose_name='Customer Category')),
                ('CustomerType', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.customertype', verbose_name='Customer Type')),
                ('Province', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.province', verbose_name='Province Name')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ContratctType', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.contracttype', verbose_name='Contract Sub Type')),
            ],
        ),
        migrations.AddField(
            model_name='contract',
            name='CStatus',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.contractstatus', verbose_name='Contract Status'),
        ),
        migrations.AddField(
            model_name='contract',
            name='Client',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.client', verbose_name='Client'),
        ),
        migrations.AddField(
            model_name='contract',
            name='ContractSLA',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.contractsla', verbose_name='Contract SLA'),
        ),
        migrations.AddField(
            model_name='contract',
            name='ContractType',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.contracttype', verbose_name='Contract Type'),
        ),
        migrations.AddField(
            model_name='contract',
            name='EndClient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.endclient', verbose_name='End Client'),
        ),
        migrations.AddField(
            model_name='client',
            name='Country',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.country', verbose_name='Country'),
        ),
        migrations.AddField(
            model_name='city',
            name='Province',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.province', verbose_name='Province Name'),
        ),
        migrations.AddField(
            model_name='area',
            name='City',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parashootapp.city', verbose_name='City Name'),
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
